...
Vue.component('send-request', require("./components/request/SendRequest.vue").default);
Vue.component('recipient-request', require("./components/request/recipient/RecipientRequest").default);
Vue.component('requests', require("./components/request/recipient/Requests.vue").default);
// static